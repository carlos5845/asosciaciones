...
<head>
    ...
    <title>Listado de Asociaciones con sus Archivos</title>
...
<div class="container mt-5">
    ...
    <a href="http://localhost/asociaciones/modules/vigencia_poder/form.php" class="btn btn-success mb-3">Registrar Vigencia de Poder</a>
    <a href="http://localhost/asociaciones/modules/acta_constitucion/form.php" class="btn btn-success mb-3">Registrar Acta de Constitución</a>
    <a href="http://localhost/asociaciones/modules/acta_constitucion/form.php" class="btn btn-success mb-3">Registrar Acta Padron de socios</a>
    <a href="http://localhost/asociaciones/modules/acta_constitucion/form.php" class="btn btn-success mb-3">Registrar Resolucion GDH</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($row['archivo_vigencia']): ?>
                                <a href="../../uploads/vigencia/<?= htmlspecialchars($row['archivo_vigencia']) ?>" target="_blank" class="btn btn-info btn-sm">Ver archivo</a>
                            <?php else: ?>
                                No disponible
                            <?php endif; ?>
                        </td>
                        <td>
                            <?php if ($row['archivo_acta']): ?>
                                <a href="../../uploads/constitucion/<?= htmlspecialchars($row['archivo_acta']) ?>" target="_blank" class="btn btn-info btn-sm">Ver archivo</a>
                            <?php else: ?>
                                No disponible
                            <?php endif; ?>
                        </td>
